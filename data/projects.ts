...
export const projects: Project[] = [
	...
	},
	{
		title: "Pizza Club",
		description: [
			"Static site generated by Gatsby and hosted as GitHub Page where I collect all the pizzas that I enjoyed around the World.",
		],
...
export const pastProjects: Project[] = [
	...
	},
	{
		title: "Sproxify",
		description: [
			"Sproxify intercepts Spotify links and let you choose where to play them. Through a fancy-looking button, Sproxify redirects you in the desired environment where you can finally play your music. Just where you want!",
		],
