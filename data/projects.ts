...
export const projects: Project[] = [
	{
		title: "GigPlayList",
		description: [
			"Create a playlist with the most probable songs that are going to be played at a given artist's gig.",
	...
	},
	{
		...
		tech: ["React", "Firebase", "Firestore", "third-party Auth", "Netlify"],
	},
	{
		title: "World Map Country Shapes",
		description: [
			"Build your own world map from country SVG shapes.",
	...
	},
	{
		title: "Pizza Club",
		description: [
			"Static site generated by Gatsby and hosted as GitHub Pages where I collect all the pizzas that I enjoyed around the world.",
		],
	...
	},
	{
		title: "Countdown",
		description: [
			"Create customizable countdowns with ease. Track both future and past events with dynamic titles and flexible options. Perfect for events, deadlines, and personal milestones.",
		],
		icon: ClockAlert,
		links: {
		...
		tech: ["React", "Tailwind", "Typescript", "Netlify", "Vite"],
	},
];
...
export const pastProjects: Project[] = [
	{
		...
		description: [
			...
			"Unfortunately, it has been deprecated as Google keeps suspending it for copyright infringement -.-",
		],
	...
	},
	{
		title: "Audible RSS",
		description: [
			"Get an RSS feed of the latest audiobook releases on Audible.",
	...
	},
	{
		title: "Sproxify",
		description: [
			"Sproxify intercepts Spotify links and lets you choose where to play them. Through a fancy-looking button, Sproxify redirects you to the desired environment where you can finally play your music. Just where you want!",
		],
	...
	},
	{
		title: "POMOfy",
		description: [
			"POMOfy brings the Pomodoro Technique to Spotify — a Spotify app that lets you use songs as a timer for Pomodoro sessions.",
		],
	...
	},
	{
		...
		description: [
			"Little Node/AngularJS webapp that scrapes the original menu of deliverance.co.uk and displays it in a more functional way. Adds the ability to filter, sort, and search the menu.",
		],
